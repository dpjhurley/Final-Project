                    ...
                    <form action="" onSubmit={handleFormSubmit} >
                        <div className="row">
                            ...
                            <div className="input-group input-group-icon">
                                <input type="text" placeholder="First Name" onChange={handleNameChange} />
                                <div className="input-icon">
                                    <i className="fa fa-user"></i>
                                </div>
                            </div>
                            <div className="input-group input-group-icon">
                                <input type="text" onChange={handleSurnameChange} placeholder="Last Name" />
                                <div className="input-icon">
                                    <i className="fa fa-user"></i>
                                </div>
                            </div>
                            <div className="input-group input-group-icon">
                                <input type="email" onChange={handleEmailChange} placeholder="Email Adress" />
                                <div className="input-icon">
                            ...
                            <div className="input-group input-group-icon">
                                <input type="password" onChange={handleRePasswordChange} placeholder="Retype Password" />
                                <div className="input-icon">
                                    <i className="fa fa-key"></i>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            ...
                            <div className="col-half">
                                <h4>Gender</h4>
                                <div className="input-group">
                                    <input type="radio" name="gender" value="male" onClick={handleGenderChange} id="gender-male" />
                                    <label htmlFor="gender-male" >Male</label>
                                    <input type="radio" name="gender" onClick={handleGenderChange} value="female" id="gender-female" />
                            ...
                            <div className="input-group">
                                ...
                                <input type="radio" name="payment-method" value="paypal" id="payment-method-paypal" />
                                    <label htmlFor="payment-method-paypal">
                                        <span><i className="fa fa-cc-paypal"></i>Paypal</span>
                                    </label>
                            </div>
                            <div className="input-group input-group-icon">
